		...
		return (
			...
			<div className={ classes.Auth }>
				...
				<div className={classes.Row}>
					<NavLink to="/login" className={ bgClass.join(' ')}>Sign in</NavLink>
					<NavLink to="/signup" className={ bgClass.join(' ')}>New Account</NavLink>
				</div>
				...
				<h4 className={ classes.LinkText }>Already have an account <NavLink to="/login" className={ classes.Link }>Login</NavLink>	</h4>
			</div>
			</Auxilary>
		)
	}
